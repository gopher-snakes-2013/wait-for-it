...
var ReservationsAutoUpdater = {
  ...
  requestReservations: function(rest_id){
    ...
    $.ajax({
      ...
      console.log(reservations.reservations[0].estimated_seating)
    ...
    $reservationRows = $('form.tr.reservation')
      for(var i=0; i< reservations.length; i++){
        ...
        console.log(currentReservation.id)
        console.log(currentReservation.name)
  ...
  init: function(){
    this.requestReservations(this.getRestaurant())
  }
}
;
var Restaurant = {
